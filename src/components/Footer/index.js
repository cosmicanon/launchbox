    ...
    <div className="container">
      <div className="copyright">
        <p>2021 &copy; Launch<b>BOX</b><br/><br/>
          ...
          <a href="https://ghostbyjohnmcafee.com" target="_blank"  rel="noreferrer"><img className="ghostIcon" alt="GHOST" src="https://www.ghostbyjohnmcafee.com/static/media/joincommunitylogo.3f526663.svg"/></a>
        </p>
